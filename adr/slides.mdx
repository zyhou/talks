...
<div style={{ display: 'flex', alignItems: 'center' }}>
    <img src={onestpasbon} style={{ height: 'auto', width: 'auto' }} />
    <ul>
        <Steps>
...
<img src={uptodatedoc} style={{ height: 'auto', width: 'auto' }} />
...
"An architecture decision record is a <span style={{ color: 'red'}}>short text file</span> in a format to an Alexiandran pattern that describes a <span style={{ color: 'red'}}>set to forces</span> and a <span style={{ color: 'red'}}>single decision</span> in a response to those forces."</span> - Proposé part Michael Nygard
</div>
